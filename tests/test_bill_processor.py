...
class TestBillProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.processor = BillProcessor(self.similpay_mock, self.state_mock, self.telegram_mock)
    ...
    def test_process_bills_no_bills(self):
        ...
        self.similpay_mock.query_bills.return_value = {"Code": "2", "Data": {}}
    ...
    def test_process_bills_new_bill_alert(self):
        ...
        self.similpay_mock.query_bills.return_value = {
            "Code": "1",
            "Data": {"amount": 45.50, "expirationDate": "2026-05-15T00:00:00"},
        }
        self.similpay_mock.extract_unpaid_bills.return_value = [
            {"amount": 45.50, "dueDate": "2026-05-15T00:00:00", "reference": "2128388"}
        ]
        self.similpay_mock.generate_bill_id.return_value = "water_bill_2026_05"
    ...
    def test_process_bills_already_notified(self):
        ...
        self.state_mock.ensure_table_exists.return_value = True
        self.state_mock.get_bill_state.return_value = {"notified_new": True, "urgent_sent": False}
    ...
    def test_process_bills_urgent_reminder(self):
        ...
        self.similpay_mock.query_bills.return_value = {
            "Code": "1",
            "Data": {"amount": 45.50, "expirationDate": f"{tomorrow}T00:00:00"},
        }
        self.similpay_mock.extract_unpaid_bills.return_value = [
            {"amount": 45.50, "dueDate": f"{tomorrow}T00:00:00", "reference": "2128388"}
        ]
        self.similpay_mock.generate_bill_id.return_value = "water_bill_2026_05"
    ...
    def test_process_bills_api_failure(self):
        ...
        self.assertIn("Failed to get API response", result["errors"])
